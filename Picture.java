...
public class Picture extends SimplePicture 
{
  ...
  public void grayScale()
  {
    ...
    for (Pixel[] rowArray : pixels)
    {
      for (Pixel pixelObj : rowArray)
      {
        pixelObj.setRed((pixelObj.getRed() + pixelObj.getGreen() + pixelObj.getBlue()) / 2);
        pixelObj.setGreen((pixelObj.getRed() + pixelObj.getGreen() + pixelObj.getBlue()) / 2);
        pixelObj.setBlue((pixelObj.getRed() + pixelObj.getGreen() + pixelObj.getBlue()) / 2);
      }
    }
  }
  
  public void fixingUnderwater()
  {
    Pixel[][] pixels = this.getPixels2D();
    for (Pixel[] rowArray : pixels)
    {
 ...
 bottomLeftPixel.setColor(topRightPixel.getColor());
  ...
  public void mirrorTemple()
  {
    ...
    {
      // loop from 13 to the mirror point
 ...
 // Left arm
 //loop from 158 to the mirror point
 ...
 // Right arm
 // loop from 171 to the mirror point
 ...
 bottomPixel2 = pixels[mirrorPoint2 - row - 3 + mirrorPoint2][col];
